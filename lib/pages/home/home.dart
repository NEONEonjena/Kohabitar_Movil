...
import '../paquetes/paquetes.dart';
import '../Pagos/Pagos.dart'; // ✅ Importa tu PagosScreen
import '../../main.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _pages = [
      HomeContent(username: widget.username), // 0 Inicio
      UserScreen(username: widget.username, password: widget.password), // 1 Perfil
      const SettingsPage(), // 2 Configuración
      Container(child: const Center(child: Text('Visitantes'))), // 3 Visitantes
      ZonasComunesPage(), // 4 Zonas Comunes
      const PagosScreen(), // 5 ✅ Pagos
      Container(child: const Center(child: Text('Reportes'))), // 6 Reportes
      NotificacionesPage(), // 7 Notificaciones
      const PaquetesScreen(), // 8 Paquetes
      Container(child: const Center(child: Text('PQRs'))), // 9 PQRs
    ];
  }
